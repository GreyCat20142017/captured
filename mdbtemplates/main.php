    ...
    <div class="page__main-wrapper page__main-wrapper--intro container">
        ...
        <section class="authorization">
            ...
            <form class="authorization__form form" action="index.php" method="post">
                <div class="authorization__input-wrapper form__input-wrapper <?= get_field_validation_classname ($errors, 'email'); ?>">
                ...
                <div class="authorization__input-wrapper form__input-wrapper <?= get_field_validation_classname ($errors, 'password'); ?>">
                ...
                <a class="authorization__recovery" href="password_recovery.php">Восстановить пароль</a>

<section class="adding-post__quote tabs__content tabs__content--active">
    ...
    <form class="adding-post__form form" action="adding.php" method="post">
            ...
            <div class="adding-post__input-wrapper form__textarea-wrapper <?= get_field_validation_classname($errors,
                ...
                <div class="form__input-section">
                    <textarea class="adding-post__textarea adding-post__textarea--quote form__textarea form__input"
                              id="post-text" placeholder="Плейсхолдер инпута" name="quote-text">
                        <?= get_pure_data($post, 'quote-text'); ?>
                    </textarea>
        ...
        <div class="adding-post__buttons">
            <button class="adding-post__submit button button--main" type="submit" name="publish_quote">Опубликовать</button>
